       ...
       <!-- product -->
        ...
        <div class="product">
         ...
         <div class="add-to-cart">
          <button class="add-to-cart-btn" ><a href="AddToCartAction.jsp?product_ID=<%=rs.getString(10) %>"><i class="fa fa-shopping-cart"> add to cart </i></a></button>
         </div>
        </div>
...
<div class="product-body">
<p class="product-sumsong"><%=rs.getString(6) %></p>
