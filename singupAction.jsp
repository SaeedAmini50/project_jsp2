...
PreparedStatement ps = con.prepareStatement("INSERT INTO customer (customer_name,customer_last_name,customer_email,Security_Question,customer_answer,customer_password) values(?,?,?,?,?,?);");
...
ResultSet rs=st.executeQuery("select * from customer where customer_email='"+customer_email+"' and customer_password='"+customer_password+"'   and customer_name='"+customer_name+"' and customer_last_name='"+customer_last_name+"' and Security_Question='"+Security_Question+"' and customer_answer='"+customer_answer+"';");
while (rs.next()){
